...
//
// Demais configuracoes (calibracao, temporizacao, NTP, fila offline, amostragem,
// painel solar, polaridade do rele) sao geridas pelo painel web e sincronizadas
// pelo firmware via GET /device/config. Pinos de hardware ficam em hardware_defaults.h.
